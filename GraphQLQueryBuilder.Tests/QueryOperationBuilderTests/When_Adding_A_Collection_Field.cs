...
{
    public class When_Adding_A_Collection_Field : QueryOperationBuilderTest
    {
        public When_Adding_A_Collection_Field(GraphQLOperationType operationType) : base(operationType)
        {
        }
